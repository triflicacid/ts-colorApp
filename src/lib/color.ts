...
export type NColorFormat = "rgb" | "rgba" | "hsl" | "hsv" | "cmyk" | "cmy" | "xyz" | "xyY" | "lab" | "lch" | "luv" | "hlab" | "lms";
...
export type ColorData = NColorData | string;
 ...
 */
export function col2col<U extends ColorData = ColorData, V extends ColorData = ColorData>(data: U, cfrom: ColorFormat, cto: ColorFormat): V {
